...
export const DATA = {
  ...
  hackathons: [
    ...
    {
      title: "21+ Other Hackathons",
      dates: "2021 - 2022",
      location: "Various Locations",
      description: "Competed in multiple fintech, Web3, SaaS, and AI hackathons. Built MVPs under tight deadlines.",
      image: "https://via.placeholder.com/150/FF6B6B/ffffff?text=Hackathons",
      links: [],
    },
  ],
